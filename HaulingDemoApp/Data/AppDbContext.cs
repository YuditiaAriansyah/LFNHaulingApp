    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TyreProblem>(entity =>
            {
                ...
                entity.Property(e => e.SerialNumber).HasColumnName("NoSeriTyre").HasMaxLength(100);
                entity.Property(e => e.MerkType).HasMaxLength(100);
                entity.Property(e => e.Size).HasMaxLength(50);
                entity.Property(e => e.Problem).HasColumnName("ProblemDescription").HasMaxLength(500);
                entity.Property(e => e.Kerusakan).HasMaxLength(500);
                entity.Property(e => e.Location).HasMaxLength(100);
                entity.Property(e => e.StartHM).HasPrecision(18, 4);
                entity.Property(e => e.EndHM).HasPrecision(18, 4);
                entity.Property(e => e.TotalHM).HasPrecision(18, 4);
                entity.Property(e => e.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP");
                entity.Property(e => e.UpdatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP");
            });
